...
while ($div = $jabatan->getResult()) {
    ...
    <td style="font-size: 22px;">
        <a href="jabatan.php?id=' . $div['jabatan_id'] . '" title="Edit Data">
        <i class="bi bi-pencil-square text-warning"></i>
        </a>&nbsp;
        <a href="jabatan.php?hapus=' . $div['jabatan_id'] . '" title="Delete Data"><i class="bi bi-trash-fill text-danger"></i></a>
        </td>
    </tr>';
    $no++;
}
