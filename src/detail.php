    ...
    if ($id > 0) {
        ...
        <div class="card-body text-end">
            ...
            <div class="card-footer text-end">
                <a href="form.php?edit=' . $row['pengurus_id'] .'"><button type="button" class="btn btn-success text-white">Ubah Data</button></a>
                <a href="detail.php?del=' . $row['pengurus_id'] . '"><button type="button" class="btn btn-danger">Hapus Data</button></a>
            </div>';
    }
}
...
if (isset($_GET['del'])) {
    $id = $_GET['del'];
    if ($id > 0) {
        if ($pengurus->deletePengurus($id) > 0) {
            echo 
            "
            <script>
